...
data0 = [float( line.rstrip('\n')) for line in open('mc0.5000000.txt')]
data1 = [float( line.rstrip('\n')) for line in open('mc0.5000001.txt')]
data2 = [float( line.rstrip('\n')) for line in open('mc0.5000002.txt')]
data3 = [float( line.rstrip('\n')) for line in open('mc0.5000003.txt')]

temp1=np.append(data0,data1)
